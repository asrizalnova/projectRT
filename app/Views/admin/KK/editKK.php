...
<head>
    ...
    <title>Edit Kartu Keluarga (KK)</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <form action="<?= site_url('kk/update/' . $kk['noKK']) ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" id="noKK" name="noKK" value="<?= $kk['noKK']; ?>" disabled>
            </div>
            <div class="form-group">
                <label for="namaKK">Nama Kepala Keluarga:</label>
                <input type="text" id="namaKK" name="namaKK" value="<?= old('namaKK', $kk['namaKK']); ?>" required>
            </div>
            <div class="form-group">
